...
class MeetingEndedWebhookRequest extends FormRequest
{
    /**
    ...
    public function toDto(): MeetingEndedWebhookData
    {
        ...
        return MeetingEndedWebhookData::fromPayloadObject(
            $payloadObject,
    ...
    {
        return [
            'event' => ['required', 'string', Rule::in(['meeting.ended'])],
