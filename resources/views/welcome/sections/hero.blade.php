<section class="landing-hero py-5">
  <div class="container">
    <div class="row align-items-center g-4">
      <div class="col-lg-6">
        <p class="landing-hero_eyebrow text-uppercase mb-3">Smarter Team workspace</p>
      ...
      <div class="col-lg-6">
        <figure class="landing-hero_figure m-0">
          <img class="img-fluid" src="{{ asset('img/team_checklist.png') }}" alt="Team collaborating and tracking work">
        </figure>
      </div>
    </div>
  </div>
